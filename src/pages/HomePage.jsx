  ...
  return (
    <div className="container">
      ...
      <section className="section">
        ...
        <p className="lede">EvadeGPT — AI Humanizer built with Next.js, Supabase Auth, Stripe subscriptions, and GPT pipelines.</p>

        <div className="featured-card">
          <a className="project-image-link" href="https://www.evadegpt.ai/" target="_blank" rel="noopener noreferrer">
            <img src={EvadegptImage} alt="EvadeGPT case study" />
          </a>
      ...
      <section className="section">
        ...
        <div className="timeline">
          <div className="timeline-item">
            <h4>Founder / Engineer — EvadeGPT.ai</h4>
